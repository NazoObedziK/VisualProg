	...
	public partial class Form1 : Form
	{
		...
		private void readXML_Click(object sender, EventArgs e)
		{
			//функція, що зчитує з XML-файлу дані в текст-бокси
				...
				using (XmlTextReader reader = new XmlTextReader(@"C:\Users\nazar\Desktop\lab4\Lab4\config_me.xml"))
			//якщо не прописувати явно шлях, просто назва файлу,то зберігається в Debug
			//using (XmlTextReader reader = new XmlTextReader("config_me.xml"))
			{
				...
				XmlNodeType type;
					while (reader.Read())
					{
						...
						{
							if (reader.Name == "textBox1")
							{
								reader.Read();
							    textBox1.Text = reader.Value;
						}
							if (reader.Name == "textBox2")
							{
								reader.Read();
							    textBox2.Text = reader.Value;
							}
						if (reader.Name == "textBox3")
						{
							reader.Read();
							textBox3.Text = reader.Value;
						}
						if (reader.Name == "textBox4")
						{
							reader.Read();
							textBox4.Text = reader.Value;
						}
						if (reader.Name == "textBox5")
						{
							reader.Read();
							textBox5.Text = reader.Value;
						}
						if (reader.Name == "textBox6")
						{
							reader.Read();
							textBox6.Text = reader.Value;
						}
						if (reader.Name == "radioButton1")
						{
							radioButton1.Checked=true;
						}
						if (reader.Name == "radioButton2")
						{
							radioButton2.Checked = true;
						}
						if (reader.Name == "radioButton3")
						{
							radioButton3.Checked = true;
						}
						if (reader.Name == "radioButton4")
						{
